...
export default function Numbers() {
  return (
    <section
      class="py-20 xl:pt-24 xl:pb-32 bg-white white-bg-image"
      id="Numbers"
    >
      <div class="container px-4 mx-auto">
        <div class="text-center">
          ...
          <h3 class="mb-4 text-4xl md:text-5xl text-coolGray-900 font-bold tracking-tighter">
          ...
          <div class="flex flex-wrap justify-center -mx-4">
            <div class="w-full md:w-1/3 lg:w-1/4 px-4 mb-8 lg:mb-0">
              <h2 class="mb-2 text-4xl md:text-5xl text-coolGray-900 font-bold tracking-tighter">
                $300m
              </h2>
