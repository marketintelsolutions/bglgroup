...
export default function Alert({ show, alerttype }) {
  ...
  return <div className="absolute bottom-10 left-10">{}</div>;
}
...
const AlertFour = () => {
  return (
    <div
      id="alert-4"
      class="flex p-4 mb-4 bg-yellow-100 rounded-lg dark:bg-yellow-200"
      role="alert"
    >
      <svg
        aria-hidden="true"
      ...
      <div class="ml-3 text-sm font-medium text-yellow-700 dark:text-yellow-800">
        ...
        <a
          href="#"
          class="font-semibold underline hover:text-yellow-800 dark:hover:text-yellow-900"
        >
          example link
        </a>
        . Give it a click if you like.
